...
user_movie = '/ml-100k/u.data'
movie_information = '/ml-100k/u.item'
...
def gender_analysis():
    ...
    ratings = pd.read_table('/ml-100k/u.data',names = rnames,engine = 'python')
    ...
    items = pd.read_table('/ml-100k/u.item',sep = '\|',names = inames,engine = 'python')
